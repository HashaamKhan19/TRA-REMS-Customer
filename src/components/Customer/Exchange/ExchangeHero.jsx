...
const ExchangeHero = () => {
    return (
        <main class="mb-[50px] flex flex-col items-center pt-[100px] sm:mb-[60px] md:mb-[70px] lg:mb-[80px] xl:mb-[90px] 2xl:mb-[100px] 2xl:pt-[150px]">
            <section class="flex w-full flex-col items-center bg-[url('/src/assets/images/exchange-page-cover.png')] bg-right-bottom bg-no-repeat">
