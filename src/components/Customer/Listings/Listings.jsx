...
const Listings = () => {
  return (
    ...
    <div>
      ...
      <div
        class="listings mt-[80px] w-full px-[5%] md:mt-[100px] lg:mt-[120px] xl:mt-[140px] 2xl:mt-[170px]"
      >
        <div
          class="mb-[30px] flex items-center justify-between sm:mb-[35px] md:mb-[40px] lg:mb-[45px] xl:mb-[50px]"
        >
          <h1
            class="text-[22px] font-bold text-dividerBlack sm:text-[24px] md:text-[28px] lg:text-[35px] xl:text-[40px] 2xl:text-[50px]"
          >
            Premiere House Listings
          </h1>
          <Link
